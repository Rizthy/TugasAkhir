...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                <div class="sidebar-brand">
                    <a href="index.html"><i class="fas fa-gem" style="font-size: 18px"></i> <span style="font-size: 17px;"> HARTAKU </span><span style="font-size: 10px;"></span></a>
                </div>
        ...
        <footer class="main-footer" style="border-top: 3px solid #e16bb6;background-color: #fbfbfb;margin-bottom: -20px">
            <div class="footer-left">
                © <strong>HARTAKU</strong>_new_2024
            </div>
